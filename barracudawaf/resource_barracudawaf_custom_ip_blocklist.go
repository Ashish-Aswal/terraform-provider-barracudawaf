...
func resourceCudaWAFCustomIpBlocklistCreate(d *schema.ResourceData, m interface{}) error {
	...
	client.hydrateBarracudaWAFCustomIpBlocklistSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFCustomIpBlocklistUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err = client.hydrateBarracudaWAFCustomIpBlocklistSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFCustomIpBlocklistSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {
