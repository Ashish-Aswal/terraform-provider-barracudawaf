...
func makeRestAPIPayloadLdapServices(
...
func resourceCudaWAFLdapServicesCreate(d *schema.ResourceData, m interface{}) error {
	resourceEndpoint := baseURI + "/ldap-services"
	resourceCreateResponseError := makeRestAPIPayloadLdapServices(d, "POST", resourceEndpoint)
...
func resourceCudaWAFLdapServicesUpdate(d *schema.ResourceData, m interface{}) error {
	resourceEndpoint := baseURI + "/ldap-services/" + d.Get("name").(string)
	resourceUpdateResponseError := makeRestAPIPayloadLdapServices(d, "PUT", resourceEndpoint)
...
func resourceCudaWAFLdapServicesDelete(d *schema.ResourceData, m interface{}) error {
	resourceEndpoint := baseURI + "/ldap-services/" + d.Get("name").(string)
	resourceDeleteResponseError := makeRestAPIPayloadLdapServices(d, "DELETE", resourceEndpoint)
