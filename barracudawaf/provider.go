...
func Provider() *schema.Provider {
	...
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"barracudawaf_module_log_levels":           resourceCudaWAFModuleLogLevels(),
			...
			"barracudawaf_ntp_servers":                 resourceCudaWAFNtpServers(),
			...
			"barracudawaf_trap_receivers":              resourceCudaWAFTrapReceivers(),
			...
			"barracudawaf_local_hosts":                 resourceCudaWAFLocalHosts(),
