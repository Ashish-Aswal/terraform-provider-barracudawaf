...
func resourceCudaWAFInterfaceRoutesCreate(d *schema.ResourceData, m interface{}) error {
	...
	client.hydrateBarracudaWAFInterfaceRoutesSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFInterfaceRoutesUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err = client.hydrateBarracudaWAFInterfaceRoutesSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFInterfaceRoutesSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {
