...
func resourceCudaWAFNotificationConfigurationCreate(d *schema.ResourceData, m interface{}) error {
	...
	client.hydrateBarracudaWAFNotificationConfigurationSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFNotificationConfigurationUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err = client.hydrateBarracudaWAFNotificationConfigurationSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFNotificationConfigurationSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {
