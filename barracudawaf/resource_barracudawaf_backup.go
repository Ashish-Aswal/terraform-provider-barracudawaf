...
func resourceCudaWAFBackupCreate(d *schema.ResourceData, m interface{}) error {
	...
	client.hydrateBarracudaWAFBackupSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFBackupUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err = client.hydrateBarracudaWAFBackupSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFBackupSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {
