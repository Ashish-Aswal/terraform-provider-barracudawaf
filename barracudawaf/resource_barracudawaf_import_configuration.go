...
func resourceCudaWAFImportConfigurationCreate(d *schema.ResourceData, m interface{}) error {
	...
	client.hydrateBarracudaWAFImportConfigurationSubResource(d, name, resourceEndpoint)
...
func resourceCudaWAFImportConfigurationUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err = client.hydrateBarracudaWAFImportConfigurationSubResource(d, name, resourceEndpoint)
...
func (b *BarracudaWAF) hydrateBarracudaWAFImportConfigurationSubResource(
	d *schema.ResourceData,
	name string,
	endpoint string,
) error {
