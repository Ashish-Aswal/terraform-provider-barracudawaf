		...
		Schema: map[string]*schema.Schema{
			...
			"authentication": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"send_domain_name":                 {Type: schema.TypeString, Optional: true},
						"dual_authentication":              {Type: schema.TypeString, Optional: true},
						"secondary_authentication_service": {Type: schema.TypeString, Optional: true},
						"authentication_service":           {Type: schema.TypeString, Optional: true},
						"status":                           {Type: schema.TypeString, Optional: true},
						"access_denied_page":               {Type: schema.TypeString, Optional: true},
						"session_timeout_for_activesync":   {Type: schema.TypeString, Optional: true},
						"cookie_domain":                    {Type: schema.TypeString, Optional: true},
						"cookie_path":                      {Type: schema.TypeString, Optional: true},
						"session_replay_protection_status": {Type: schema.TypeString, Optional: true},
						"creation_timeout":                 {Type: schema.TypeString, Optional: true},
						"dual_login_page":                  {Type: schema.TypeString, Optional: true},
						"idle_timeout":                     {Type: schema.TypeString, Optional: true},
						"login_challenge_page":             {Type: schema.TypeString, Optional: true},
						"login_failed_page":                {Type: schema.TypeString, Optional: true},
						"login_page":                       {Type: schema.TypeString, Optional: true},
						"login_processor_path":             {Type: schema.TypeString, Optional: true},
						"openidc_redirect_url":             {Type: schema.TypeString, Optional: true},
						"openidc_attribute_name":           {Type: schema.TypeString, Optional: true},
						"openidc_local_id":                 {Type: schema.TypeString, Optional: true},
						"login_successful_page":            {Type: schema.TypeString, Optional: true},
						"challenge_prompt_field":           {Type: schema.TypeString, Optional: true},
						"challenge_user_field":             {Type: schema.TypeString, Optional: true},
						"login_failure_url":                {Type: schema.TypeString, Optional: true},
						"login_success_url":                {Type: schema.TypeString, Optional: true},
						"logout_page":                      {Type: schema.TypeString, Optional: true},
						"logout_processor_path":            {Type: schema.TypeString, Optional: true},
						"logout_successful_page":           {Type: schema.TypeString, Optional: true},
						"logout_success_url":               {Type: schema.TypeString, Optional: true},
						"password_expired_url":             {Type: schema.TypeString, Optional: true},
						"post_processor_path":              {Type: schema.TypeString, Optional: true},
						"saml_logout_url":                  {Type: schema.TypeString, Optional: true},
						"action":                           {Type: schema.TypeString, Optional: true},
						"groups":                           {Type: schema.TypeString, Optional: true},
						"sso_cookie_update_interval":       {Type: schema.TypeString, Optional: true},
						"max_failed_attempts":              {Type: schema.TypeString, Optional: true},
						"count_window":                     {Type: schema.TypeString, Optional: true},
						"enable_bruteforce_prevention":     {Type: schema.TypeString, Optional: true},
						"kerberos_debug_status":            {Type: schema.TypeString, Optional: true},
						"kerberos_enable_delegation":       {Type: schema.TypeString, Optional: true},
						"kerberos_ldap_authorization":      {Type: schema.TypeString, Optional: true},
						"krb_authorization_policy":         {Type: schema.TypeString, Optional: true},
						"master_service":                   {Type: schema.TypeString, Optional: true},
						"master_service_url":               {Type: schema.TypeString, Optional: true},
						"service_provider_display_name":    {Type: schema.TypeString, Optional: true},
						"service_provider_entity_id":       {Type: schema.TypeString, Optional: true},
						"service_provider_org_name":        {Type: schema.TypeString, Optional: true},
						"service_provider_org_url":         {Type: schema.TypeString, Optional: true},
						"attribute_format":                 {Type: schema.TypeString, Optional: true},
						"attribute_id":                     {Type: schema.TypeString, Optional: true},
						"attribute_name":                   {Type: schema.TypeString, Optional: true},
						"attribute_type":                   {Type: schema.TypeString, Optional: true},
						"encryption_certificate":           {Type: schema.TypeString, Optional: true},
						"signing_certificate":              {Type: schema.TypeString, Optional: true},
					},
				},
			},
			"caching": {
			...
			"exception_profiling": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"exception_profiling_trusted_host_group":      {Type: schema.TypeString, Optional: true},
						"exception_profiling_learn_from_trusted_host": {Type: schema.TypeString, Optional: true},
						"exception_profiling_level":                   {Type: schema.TypeString, Optional: true},
					},
				},
			},
			"ftp_security": {
			...
			"advanced_configuration": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"enable_web_application_firewall": {Type: schema.TypeString, Optional: true},
						"accept_list":                     {Type: schema.TypeString, Optional: true},
						"accept_list_status":              {Type: schema.TypeString, Optional: true},
						"proxy_list":                      {Type: schema.TypeString, Optional: true},
						"proxy_list_status":               {Type: schema.TypeString, Optional: true},
						"ddos_exception_list":             {Type: schema.TypeString, Optional: true},
						"enable_fingerprint":              {Type: schema.TypeString, Optional: true},
						"enable_http2":                    {Type: schema.TypeString, Optional: true},
						"keepalive_requests":              {Type: schema.TypeString, Optional: true},
						"ntlm_ignore_extra_data":          {Type: schema.TypeString, Optional: true},
						"enable_proxy_protocol":           {Type: schema.TypeString, Optional: true},
						"enable_vdi":                      {Type: schema.TypeString, Optional: true},
						"enable_websocket":                {Type: schema.TypeString, Optional: true},
					},
				},
			},
			"basic_security": {
			...
			"ssl_client_authentication": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"client_certificate_for_rule":      {Type: schema.TypeString, Optional: true},
						"client_authentication_rule_count": {Type: schema.TypeString, Required: true},
						"client_authentication":            {Type: schema.TypeString, Optional: true},
						"enforce_client_certificate":       {Type: schema.TypeString, Optional: true},
						"trusted_certificates":             {Type: schema.TypeString, Optional: true},
					},
				},
			},
			"ssl_security": {
